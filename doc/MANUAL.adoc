...
This backend stores data in a HTTP/WebDAV compatible server. The required HTTP
...
* The cpp-httplib cannot handle URLs containing IPv6 addresses like: `http://[::1]/`
* The cpp-httplib does not support connection keep-alive
* Authentication and HTTPS are not supported
